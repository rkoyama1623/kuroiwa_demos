...
import csv, argparse, numpy, math, time, struct, sys
    ...
    def __init__(self, log_name, yaml_name):
        ...
        for r in range(self.row_num):
            ...
            for c in range(self.col_num):
                self.items[r].append(self.view.addPlot(row=r, col=c))
            ...
            for plt_i, plt in enumerate(self.plots[k]): # plt : sh_qOut / ic_q / ...
                ...
                for l_i, l in enumerate(self.target_limbs): # l : {"rleg" : [0, 5]} / {"lleg" : [6, 11]} / ...
                    for c_i in range(l.values()[0][0], l.values()[0][1]+1, 1): # c_i : 6 / 7 / 8 / ...
                        ...
                        self.items[k_i * len(self.target_limbs) + l_i][c_i - l.values()[0][0]].plot(t_vals, [x for x in y_vals[:, c_i]])
